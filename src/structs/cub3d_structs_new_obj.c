 ...
 *
 * TODO: Verify if this function is responsible for rendering sprites and fix
 * the perspective problem
 */
static void sage(st_wndw *wndw, st_obj *obj, st_actor *p)
{
    int org_sx;
    int end_sx;
 ...
 * return it.
 */
static float get_p_rl_ang(st_static_obj obj, st_actor *p)
{
    float ret;
...
st_obj new_obj(st_wndw *wndw, st_actor *p, st_static_obj obj)
{
    ...
    {
        new.visible = 0;
        new.dist = (float)INT_MAX; // TODO: Rediscorver why this was used this way
    }
